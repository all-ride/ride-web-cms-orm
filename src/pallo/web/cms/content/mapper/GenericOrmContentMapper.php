...
namespace pallo\web\cms\content\mapper;
...
class GenericOrmContentMapper extends OrmContentMapper {
	 ...
	 * @var pallo\library\widget\WidgetProperties
	 */
	 ...
	 * @param pallo\library\cms\node\Node $node
	 * @param pallo\library\widget\WidgetProperties $properties
	 * @return null
	 */
	 ...
	 * @return pallo\library\cms\content\Content Generic content object
	 */
	...
	protected function parseArguments($index, $site, $locale) {
	    ...
	    $this->arguments[$index] = array(
            ...
            self::PROPERTY_URL => $this->baseScript . $this->node->getRoute($locale) . '/',
        );
	}
